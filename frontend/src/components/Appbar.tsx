  ...
  return (
    <div className="w-full flex justify-between place-items-center px-9 py-3 border-b">
        ...
        <div className="flex justify-center place-items-center gap-4">
          <Link to={"/blogs/publish"}><button type="button" className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 ">New</button></Link>
          ...
          <button type="button" onClick={handleLogout} className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Logout</button>
        </div>
    </div>
  )
}
