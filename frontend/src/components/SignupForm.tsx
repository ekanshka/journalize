...
export const SignupForm = () => {
  ...
  useEffect(() => {
    if (errors.email || errors.name || errors.password || errors.root) {
        alert(errors.email?.message || errors.name?.message || errors.password?.message || errors.root?.message)
    }
  }, [errors])
    ...
    >
      <div className="flex flex-col gap-3 text-center">
        ...
        <h4 className="text-gray-500">
          ...
          <Link to="/signin" className="cursor-pointer text-gray-500 underline">
            Login
          </Link>
        </h4>
      </div>
